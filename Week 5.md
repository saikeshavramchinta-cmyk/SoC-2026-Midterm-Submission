...
If the Sharpe ratio is about efficiency, MDD is about pain tolerance. It measures the worst-case scenario: the largest single percentage drop from an all-time high in your equity curve to the subsequent lowest point.
## $$\text{MDD} = \frac{\text{Peak Value} - \text{Trough Value}}{\text{Peak Value}}$$
What it means: If your account grows from $100 to $200, drops to $100, and then grows to $300, your Maximum Drawdown is $50\%$ (the drop from $200$ to $100$). Many hedge funds strictly monitor MDD because a $50\%$ drawdown requires a $100\%$ return just to get back to breakeven.
## Win Rate
Win rate is simply your accuracy.
